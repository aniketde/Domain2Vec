...
class TaskEmbeddingNetworkNaive:
    ...
    def predictions(self, sess, test_iterator, test_tasks, examples_per_task):
        """
        ...
        :return:
        """
        num_samples = examples_per_task*test_tasks
        ...
        for i in range(test_tasks * (examples_per_task//labels_batch.shape[0])):
...
class SingleGraph:
    ...
    This is the graph for single task training
    """
    def __init__(self, hidden_layers=None, input_features_dim=2, learning_rate=0.01, weight_decay=0.0005):
        self._learning_rate = learning_rate
